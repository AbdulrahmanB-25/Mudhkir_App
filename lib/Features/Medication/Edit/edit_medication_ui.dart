...
import '../Add/Add_Dosage.dart';
import '../Add/Add_Name_Picture.dart';
import '../Add/Add_Start_&_End_Date.dart';
import 'EditMedication_Page.dart';
...
// Core provider for edit medication UI state management
class EditMedicationDataProvider {
  ...
  // Complex image upload and error handling
  ...
  Future<Map<String, String>> _uploadToImgBB(File file) async {
    ...
    if (resp.statusCode != 200) throw Exception('ImgBB upload failed');
    final data = json.decode(resp.body)['data'];
    return {'url': data['url'] as String, 'deleteUrl': data['delete_url'] as String};
  }

  // Core update logic with error handling
